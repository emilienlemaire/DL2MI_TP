...
void display()
{
	...
	vec3 colors[4] = {vec3(1.0, 0.0, 0.0), vec3(1.0, 0.0, 0.0), vec3(0.0, 0.0, 1.0), vec3(0.0, 0.0, 1.0)};
	vec2 points[4] = {
	        vec2(window.get_height() * window.get_sample() * 1 / 3, window.get_height() * window.get_sample() * 1 / 3),
	        vec2(window.get_height() * window.get_sample() * 1 / 3, window.get_height() * window.get_sample() * 3 / 4),
	        vec2(window.get_height() * window.get_sample() * 3 / 4, window.get_height() * window.get_sample() * 3 / 4),
	        vec2(window.get_height() * window.get_sample() * 3 / 4, window.get_height() * window.get_sample() * 1 / 3)
	};

    /*for (int i = ((window.get_height() * window.get_sample()) / 2); i < (window.get_height() * window.get_sample() * 3 / 4); ++i) {
        vec3 colors_line[2] = {colors[0], colors[1]};
        window.draw_horizontal_line((int)(i), (int)(window.get_height() / 2), (int)((window.get_height() * 3) / 4), colors_line);
    }*/
